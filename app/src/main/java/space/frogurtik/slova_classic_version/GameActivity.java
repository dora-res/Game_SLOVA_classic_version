package space.frogurtik.slova_classic_version;
...
public class GameActivity extends AppCompatActivity {
    ...
    void preparing_to_game(){
        ...
        TV_count_of_player.setText("Кол-во игроков: " + count_of_gamers);
    ...
    void game_start(){
        ...
        else if (list_of_all_words.contains(new_word)) {
            ...
            countDownTimer.cancel();
                ...
                if (toChar_new_word[0].toUpperCase().equals(na_kakuyi_bukvu_slovo)){
                    ...
                    if (toChar_new_word[toChar_new_word.length - 1].toUpperCase().equals("Ь") ||
                        ...
                        na_kakuyi_bukvu_slovo = toChar_new_word[toChar_new_word.length - 1].toUpperCase();
                    }
                    TV_slovo_na_bukvu.setText("Введите слово на букву " + na_kakuyi_bukvu_slovo);
                    ET_new_word_fron_player.setText("");
                    list_of_all_words.add(new_word);
